...
//
//     if($('.social-buttons-left').children().eq(0).css('margin-left')=="-221.547px" || $('.social-buttons-left').children().eq(0).css('margin-left')=="-152.547px" || $('.social-buttons-left').children().eq(0).css('margin-left')=="-118.047px") {
